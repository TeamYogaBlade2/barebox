...
#define MTK_PULL_TYPE_MASK                             \
	(MTK_PULL_PU_PD_TYPE | MTK_PULL_PULLSEL_TYPE | \
	 MTK_PULL_PUPD_R1R0_TYPE | MTK_PULL_RSEL_TYPE)

// KEPT FOR COMPAT!
#define EINT_NA U16_MAX
#define NO_EINT_SUPPORT EINT_NA

#define PIN_FIELD_CALC(_s_pin, _e_pin, _i_base, _s_addr, _x_addrs, _s_bit, \
...
#define PIN_FIELD(_s_pin, _e_pin, _s_addr, _x_addrs, _s_bit, _x_bits)         \
	PIN_FIELD_CALC(_s_pin, _e_pin, 0, _s_addr, _x_addrs, _s_bit, _x_bits, \
		       32, 0)
...
/**
 * struct mtk_eint_desc - the structure that providing information KEPT FOR COMPAT!
...
struct mtk_pin_desc {
	unsigned int number;
	const char *name;
	struct mtk_eint_desc eint; // KEPT FOR COMPAT!
	u8 drv_n;
...
struct mtk_pin_soc {
	...
	int (*bias_set)(struct mtk_pinctrl *hw, const struct mtk_pin_desc *desc,
			bool pullup);
	int (*bias_get)(struct mtk_pinctrl *hw, const struct mtk_pin_desc *desc,
			bool pullup, int *res);
